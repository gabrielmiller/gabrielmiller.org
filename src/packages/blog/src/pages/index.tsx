    ...
    return (
        <div className="container">
            ...
            <main>
                ...
                <p>I'm interested in most things web-development, data, databases, security, and GIS. I'm a software engineer at <a href="https://www.digitalonboarding.com/">Digital Onboarding</a>. I previously have worked at <a href="https://heggerty.org/">Heggerty</a> and <a href="https://www.jazzhr.com">JazzHR</a>(fka <em>Jazz</em> and <em>The Resumator</em>). I have over 13 years of full-stack web development experience. I also have expertise in software architecture, distributed systems, and data.</p>
                ...
                <p>Page last updated 2026-01-23.</p>
            </main>
        </div>
    )
}
