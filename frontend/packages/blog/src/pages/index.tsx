    ...
    return (
        <div className="container">
            ...
            <main>
                ...
                <p>I'm interested in most things web-development, databases, security, and GIS. I'm a software engineer at <a href="https://www.jazzhr.com">JazzHR</a>, which was formerly known as <em>Jazz</em> and before that <em>The Resumator</em>. I have 10+ years of full-stack web development experience and gravitate toward front-end development, testing, and data.</p>
